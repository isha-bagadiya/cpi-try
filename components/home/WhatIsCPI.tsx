const WhatIsCPI: React.FC = () => {
    return <div className="bg-dark-gray">
        <div className="mx-auto bg-white text-black flex flex-col md:flex-row items-center justify-between px-16 py-24 rounded-[30px]">
            ...
            <div className="min-w-[100%] md:min-w-[35%]">
                ...
                <div className="font-mori font-semibold text-5xl mt-8">What is CPI?</div>
            </div>
            <div className="font-mori font-normal text-[#1E1E1E] text-2xl leading-[3rem] tracking-tighter mt-6 md:mt-auto ml-auto md:ml-4">
